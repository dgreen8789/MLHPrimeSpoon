...
export default class Nav extends Component {
  ...
  home(){
    return (
      ...
      <Image source ={require('../../images/logo.png')} resizeMode = "contain" style={{left: 17 ,top: 15, width:100, height:50}} />
  ...
  profile(){
    ...
    return (
      <View  style={styles.container}>
      <TouchableOpacity onPress ={this.props.onPress}>
      <Image source = {require('../../images/spoon.png')} resizeMode = "contain" style = {{width:25, height:25, margin:10}}/>
      </TouchableOpacity>
      <Image source ={require('../../images/logo.png')} resizeMode = "contain" style={{width:100, height:30}} />
      <View style = {{width:25, height:25, margin:10}}/>
      </View>
